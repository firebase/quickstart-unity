...
namespace Tests {
  internal static class SerializationTestData {
    ...
    private static DateTimeOffset dateTimeOffset =
        new DateTimeOffset(1990, 1, 2, 3, 4, 5, TimeSpan.FromHours(1));
    ...
    // Test data that is serializable, but cannot be deserialized into the original types.
    public static IEnumerable<TestCase> UnsupportedReadToInputTypesTestData() {
      return new List<TestCase> {
    ...
    internal class GameResult : IEquatable<GameResult> {
      ...
      public bool Equals(GameResult other) {
        return other != null && other.Name == Name && other.Score == Score;
      }
    }
    ...
    internal class NullableContainer : IEquatable<NullableContainer> {
      ...
      public override int GetHashCode() {
        return (int)NullableValue.GetValueOrDefault().GetHashCode();
      }

      public override bool Equals(object obj) {
        return Equals(obj as NullableContainer);
      }

      public bool Equals(NullableContainer other) {
        return other != null && other.NullableValue == NullableValue;
      }
      public override string ToString() {
        return String.Format("NullableContainer: {0}", NullableValue.GetValueOrDefault());
      }
    }
    ...
    internal class NullableEnumContainer : IEquatable<NullableEnumContainer> {
      ...
      public override bool Equals(object obj) {
        return Equals(obj as NullableEnumContainer);
      }

      public bool Equals(NullableEnumContainer other) {
        return other != null && other.NullableValue == NullableValue;
      }
    }
    ...
    internal class DictionaryInterfaceContainer : IEquatable<DictionaryInterfaceContainer> {
      ...
      public override int GetHashCode() {
        return Integers.Sum(pair => pair.Key.GetHashCode() + pair.Value);
      }

      public override bool Equals(object obj) {
        return Equals(obj as DictionaryInterfaceContainer);
      }
      ...
      public bool Equals(DictionaryInterfaceContainer other) {
        ...
        int otherValue;
        return Integers.All(pair => other.Integers.TryGetValue(pair.Key, out otherValue) &&
                                    pair.Value == otherValue);
      }
    }

    internal enum SByteEnum : sbyte { MinValue = sbyte.MinValue, MaxValue = sbyte.MaxValue }

    internal enum Int16Enum : short { MinValue = short.MinValue, MaxValue = short.MaxValue }

    internal enum Int32Enum : int { MinValue = int.MinValue, MaxValue = int.MaxValue }

    internal enum Int64Enum : long { MinValue = long.MinValue, MaxValue = long.MaxValue }

    internal enum ByteEnum : byte { MinValue = byte.MinValue, MaxValue = byte.MaxValue }

    internal enum UInt16Enum : ushort { MinValue = ushort.MinValue, MaxValue = ushort.MaxValue }

    internal enum UInt32Enum : uint { MinValue = uint.MinValue, MaxValue = uint.MaxValue }
    ...
    internal enum CustomConversionEnum { Foo = 1, Bar = 2 }
    ...
    public sealed class ModelWithEnums {
      ...
      [FirestoreProperty(ConverterType =
                             typeof(FirestoreEnumNameConverter<Int32Enum>))] public Int32Enum
          EnumAttributedByName { get; set; }

      [FirestoreProperty] public Int32Enum EnumByNumber { get; set; }
    ...
    public class EmailConverter : FirestoreConverter<Email> {
      ...
      public override object ToFirestore(Email value) {
    ...
    public class GuidPair {
      ...
      [FirestoreProperty(ConverterType = typeof(GuidConverter))] public Guid Guid { get; set; }

      [FirestoreProperty(ConverterType = typeof(GuidConverter))] public Guid
          ? GuidOrNull { get; set; }
    }
    ...
    public class GuidPair2 {
      ...
      [FirestoreProperty] public Guid Guid { get; set; }

      [FirestoreProperty] public Guid? GuidOrNull { get; set; }
    }
    ...
    public class GuidConverter : FirestoreConverter<Guid> {
      ...
      public override object ToFirestore(Guid value) {
    ...
    public class CustomPlayer : IEquatable<CustomPlayer> {
      ...
      public override bool Equals(object obj) {
        return Equals(obj as CustomPlayer);
      }
    ...
    internal struct CustomValueType : IEquatable<CustomValueType> {
      ...
      public override bool Equals(object obj) {
        return obj is CustomValueType && Equals((CustomValueType)obj);
      }
      public bool Equals(CustomValueType other) {
        return Name == other.Name && Value == other.Value;
      }
      public override string ToString() {
        return String.Format("CustomValueType: {0}", new { Name, Value });
      }
    }
    ...
    internal class CustomValueTypeConverter : FirestoreConverter<CustomValueType> {
      public override CustomValueType FromFirestore(object value) {
        ...
        return new CustomValueType((string)dictionary["Name"], (int)(long)dictionary["Value"]);
      }

      public override object ToFirestore(CustomValueType value) {
        return new Dictionary<string, object> { { "Name", value.Name }, { "Value", value.Value } };
      }
    }
    ...
    internal struct StructModel : IEquatable<StructModel> {
      ...
      public override bool Equals(object obj) {
        return obj is StructModel && Equals((StructModel)obj);
      }
      ...
      public override string ToString() {
        return String.Format("StructModel: {0}", new { Name, Value });
      }
    }
  }
}
